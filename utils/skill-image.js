...
import SQLServer from '../app/assets/svg/skills/sql-server.svg';
import node from '../app/assets/svg/skills/nodejs-image.webp';
...
export const skillsImage = (skill) => {
  ...
  switch (skillID) {
    ...
    case 'sqlserver':
      return SQLServer;
    default:
      console.log(`No image found for ${skill}`);
      return null;
      break;
  }
}
